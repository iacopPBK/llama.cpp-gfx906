...
#MODEL_PATH="/home/iacopo/Downloads/Qwen3-VL-4B-Instruct-Q4_1.gguf"
...
BENCH_PARAMS=(
    ...
    -r 5                       # Only 1 run after warmup (not 5 default)
    #-d 2048
)

# Benchmark configurations
QUICK_TEST="-p 1024 -n 128"                           # Quick test
STANDARD_TEST="-p 512 -n 128"    # Standard comprehensive test
