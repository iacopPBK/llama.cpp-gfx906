...
#include "gfx906/ssm-scan-dispatch.cuh"
...
static void ssm_scan_f32_cuda(const float * src0, const float * src1, const float * src2, const float * src3,
                              ...
                              cudaStream_t stream) {
    // Try GFX906 optimized kernel first (returns false if not available or not applicable)
    if (gfx906_ssm_scan_dispatch(src0, src1, src2, src3, src4, src5, src6, dst,
            src0_nb2, src0_nb3, src1_nb2, src1_nb3, src2_nb1, src2_nb2, src3_nb1,
            src4_nb2, src4_nb3, src5_nb2, src5_nb3, s_off, d_state, head_dim,
            n_head, n_group, n_tok, n_seq, stream)) {
        return;
    }
