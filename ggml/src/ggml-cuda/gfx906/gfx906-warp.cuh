...
// GFX906 Warp Reduction Functions
// Completely isolated from common.cuh - can be included by any GFX906 kernel
// without pulling in common.cuh dependencies
...
// ============================================================================
// DPP (Data Parallel Primitives) Shuffle Operations
// ============================================================================
// These provide faster warp shuffles on AMD GPUs by using DPP instructions
// instead of going through the register file.
// ============================================================================
...
// ============================================================================
// GFX906 Shuffle XOR with DPP dispatch
// ============================================================================
// Similar to ggml_cuda_shfl_xor_sync but completely isolated in gfx906 folder
// ============================================================================
...
// ============================================================================
// Warp Reduction Operations using Fused DPP Instructions
// ============================================================================

// Fused DPP add/max operations for common XOR offsets
...
// Shuffle XOR for offsets 4 and 16 (no fused operation)
...
// Generic type warp reduction (for int, etc.)
template<int width = WARP_SIZE, typename T>
